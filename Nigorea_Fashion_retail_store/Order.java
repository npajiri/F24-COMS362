...
public class Order {
    private String customerID;         // Customer ID associated with the order
    private Date orderDate;            // Represents the order's date
    private double totalCost;          // Total cost of the order
    private String shippingStatus;     // Shipping status of the order
    private String orderID;            // Unique ID for the order
    ...
    // Constructor for basic orders (fashion_retail-style)
    public Order(String customerID, Date orderDate, double totalCost, String shippingStatus, String orderID) {
    ...
    // Constructor for detailed orders
    public Order(String customerID, Date orderDate, double totalCost, String shippingStatus, String orderID, List<String> products) {
        this.customerID = customerID;
        this.orderDate = orderDate;
        this.totalCost = totalCost;
        this.shippingStatus = shippingStatus;
